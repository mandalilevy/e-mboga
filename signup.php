...
<nav class="navbar navbar-expand-md navbar-light bg-light">
 ...
 <div class="container">
  ...
  <label for="idn" class="col-sm-5 col-form-label">ID Number</label>
  <div class="col-sm-10">
      <input type="text" class="form-control" id="idn" placeholder="ID Number" name="id" maxlength="10" required="">
  </div>
  </div>
              <div class="form-group row">
  <label for="inputEmail3" class="col-sm-5 col-form-label">Full Name</label>
  <div class="col-sm-10">
      <input type="text" class="form-control" id="inputEmail3" placeholder="name" name="name" required="">
  </div>
  </div>
  <div class="form-group row">
  <label for="em" class="col-sm-5 col-form-label">Email</label>
  <div class="col-sm-10">
      <input type="email" class="form-control" id="em" name="email" placeholder="email" required="">
  </div>
  </div>
              <div class="form-group row">
  <label for="nm" class="col-sm-5 col-form-label">Phone Number</label>
  <div class="col-sm-10">
      <input type="text" class="form-control" id="nm" placeholder="contacts"  name="cont" maxlength="10" required="">
  </div>
  </div>
   <div class="form-group row">
  <label for="nm" class="col-sm-5 col-form-label">Location</label>
  <div class="col-sm-10">
      <input type="text" class="form-control" id="nm" placeholder="Location"  name="loc" maxlength="10" required="">
  </div>
  </div>
  <div class="form-group row">
  <label for="inputPassword3" class="col-sm-5 col-form-label">Category</label>
  <div class="col-sm-10">
  ...
  <option>Vendor</option>
   ...
   <div class="form-group row">
  <label for="ps" class="col-sm-5 col-form-label">Password</label>
  <div class="col-sm-10">
